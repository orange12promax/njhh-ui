import { openBlock as ai, createElementBlock as hi, defineComponent as Ln, ref as Tn, onMounted as bn } from "vue";
const ui = (t, e) => {
...
function Sn(t, e) {
  return ai(), hi("div", null, "11");
}
const ns = /* @__PURE__ */ ui(Mn, [["render", Sn], ["__file", "C:/Users/chen-pc/WebstormProjects/njhh-ui/lib/demo-ui.vue"]]);
/* @preserve
...
var li = 0;
function x(t) {
  return "_leaflet_id" in t || (t._leaflet_id = ++li), t._leaflet_id;
}
function ci(t, e, i) {
  var n, o, s, r;
  return r = function() {
...
function S(t, e) {
  Object.prototype.hasOwnProperty.call(t, "options") || (t.options = t.options ? Vt(t.options) : {});
  for (var i in e)
    t.options[i] = e[i];
  return t.options;
}
...
var Xe = 0;
function _i(t) {
  var e = +new Date(), i = Math.max(0, 16 - (e - Xe));
  return Xe = e + i, window.setTimeout(t, i);
}
var fe = window.requestAnimationFrame || ce("RequestAnimationFrame") || _i, mi = window.cancelAnimationFrame || ce("CancelAnimationFrame") || ce("CancelRequestAnimationFrame") || function(t) {
...
ot.extend = function(t) {
  ...
  }, i = e.__super__ = this.prototype, n = Vt(i);
  n.constructor = e, e.prototype = n;
  for (var o in this)
    Object.prototype.hasOwnProperty.call(this, o) && o !== "prototype" && o !== "__super__" && (e[o] = this[o]);
  return t.statics && w(e, t.statics), t.includes && (En(t.includes), w.apply(null, [n].concat(t.includes))), w(n, t), delete n.statics, delete n.includes, n.options && (n.options = i.options ? Vt(i.options) : {}, w(n.options, t.options)), n._initHooks = [], n.callInitHooks = function() {
...
H.addEventListener = H.on;
H.removeEventListener = H.clearAllEventListeners = H.off;
H.addOneTimeEventListener = H.once;
H.fireEvent = H.fire;
H.hasEventListeners = H.listens;
var At = ot.extend(H);
function p(t, e, i) {
  this.x = i ? Math.round(t) : t, this.y = i ? Math.round(e) : e;
}
var Je = Math.trunc || function(t) {
...
function _(t, e, i) {
  return t instanceof p ? t : Y(t) ? new p(t[0], t[1]) : t == null ? t : typeof t == "object" && "x" in t && "y" in t ? new p(t.x, t.y) : new p(t, e, i);
}
function C(t, e) {
  if (!!t)
...
W.prototype = {
  extend: function(t) {
    ...
    if (t instanceof P)
      ...
      return t ? this.extend(T(t) || I(t)) : this;
  ...
  contains: function(t) {
    typeof t[0] == "number" || t instanceof P || "lat" in t ? t = T(t) : t = I(t);
    var e = this._southWest, i = this._northEast, n, o;
...
function T(t, e, i) {
  return t instanceof P ? t : Y(t) && typeof t[0] != "object" ? t.length === 3 ? new P(t[0], t[1], t[2]) : t.length === 2 ? new P(t[0], t[1]) : null : t == null ? t : typeof t == "object" && "lat" in t ? new P(t.lat, "lng" in t ? t.lng : t.lon, t.alt) : e === void 0 ? null : new P(t, e, i);
}
var st = {
...
var be = document.documentElement.style, Qt = "ActiveXObject" in window, On = Qt && !document.addEventListener, vi = "msLaunchUri" in navigator && !("documentMode" in document), Me = tt("webkit"), yi = tt("android"), xi = tt("android 2") || tt("android 3"), In = parseInt(/WebKit\/([0-9]+)|$/.exec(navigator.userAgent)[1], 10), An = yi && tt("Google") && In < 537 && !("AudioNode" in window), Se = !!window.opera, wi = !vi && tt("chrome"), Pi = tt("gecko") && !Me && !Se && !Qt, Bn = !wi && tt("safari"), Li = tt("phantom"), Ti = "OTransition" in be, Nn = navigator.platform.indexOf("Win") === 0, bi = Qt && "transition" in be, ze = "WebKitCSSMatrix" in window && "m11" in new window.WebKitCSSMatrix() && !xi, Mi = "MozPerspective" in be, Rn = !window.L_DISABLE_3D && (bi || ze || Mi) && !Ti && !Li, Nt = typeof orientation < "u" || tt("mobile"), Dn = Nt && Me, Fn = Nt && ze, Si = !window.PointerEvent && window.MSPointerEvent, zi = !!(window.PointerEvent || Si), Ci = "ontouchstart" in window || !!window.TouchEvent, Wn = !window.L_NO_TOUCH && (Ci || zi), Hn = Nt && Se, Un = Nt && Pi, Gn = (window.devicePixelRatio || window.screen.deviceXDPI / window.screen.logicalXDPI) > 1, qn = function() {
  var t = !1;
  try {
...
}(), Ce = !!(document.createElementNS && pi("svg").createSVGRect), Vn = !!Ce && function() {
...
var c = {
  ...
  mac: Yn,
  linux: Xn
}, ki = c.msPointer ? "MSPointerDown" : "pointerdown", Ei = c.msPointer ? "MSPointerMove" : "pointermove", Zi = c.msPointer ? "MSPointerUp" : "pointerup", Oi = c.msPointer ? "MSPointerCancel" : "pointercancel", _e = {
  touchstart: ki,
  touchmove: Ei,
  touchend: Zi,
  touchcancel: Oi
...
function Jn(t, e, i) {
  return e === "touchstart" && eo(), Qe[e] ? (i = Qe[e].bind(this, i), t.addEventListener(_e[e], i, !1), i) : (console.warn("wrong event specified:", e), L.Util.falseFn);
}
function $n(t, e, i) {
  if (!_e[e]) {
  ...
  t.removeEventListener(_e[e], i, !1);
}
function Qn(t) {
  yt[t.pointerId] = t;
}
...
function eo() {
  ti || (document.addEventListener(ki, Qn, !0), document.addEventListener(Ei, to, !0), document.addEventListener(Zi, ei, !0), document.addEventListener(Oi, ei, !0), ti = !0);
}
function Gt(t, e) {
...
function io(t, e) {
  e.MSPOINTER_TYPE_TOUCH && e.pointerType === e.MSPOINTER_TYPE_TOUCH && B(e), Gt(t, e);
}
function no(t) {
  var e = {}, i, n;
  for (n in t)
...
), Ii = zt === "webkitTransition" || zt === "OTransition" ? zt + "End" : "transitionend";
function Ai(t) {
...
function k(t, e) {
  t.classList !== void 0 ? t.classList.remove(e) : Ze(t, we((" " + te(t) + " ").replace(" " + e + " ", " ")));
}
function Ze(t, e) {
...
function _t(t, e, i) {
  var n = e || new p(0, 0);
  t.style[ke] = (c.ie3d ? "translate(" + n.x + "px," + n.y + "px)" : "translate3d(" + n.x + "px," + n.y + "px,0)") + (i ? " scale(" + i + ")" : "");
}
function O(t, e) {
  t._leaflet_pos = e, c.any3d ? _t(t, e) : (t.style.left = e.x + "px", t.style.top = e.y + "px");
}
function mt(t) {
...
if ("onselectstart" in document)
  ...
  Ot = function() {
    ...
    Mt && (document.documentElement.style[Mt] = le, le = void 0);
  };
}
function Oe() {
  m(window, "dragstart", B);
}
function Ie() {
...
function Ae(t) {
  for (; t.tabIndex === -1; )
    t = t.parentNode;
  !t.style || (Yt(), qt = t, me = t.style.outline, t.style.outline = "none", m(window, "keydown", Yt));
}
function Yt() {
  !qt || (qt.style.outline = me, qt = void 0, me = void 0, b(window, "keydown", Yt));
}
function Bi(t) {
  do
    t = t.parentNode;
...
function ge(t, e, i, n) {
  ...
  !c.touchNative && c.pointer && e.indexOf("touch") === 0 ? s = Jn(t, e, s) : c.touch && e === "dblclick" ? s = so(t, s) : "addEventListener" in t ? e === "touchstart" || e === "touchmove" || e === "wheel" || e === "mousewheel" ? t.addEventListener(pe[e] || e, s, c.passiveEvents ? { passive: !1 } : !1) : e === "mouseenter" || e === "mouseleave" ? (s = function(a) {
    a = a || window.event, Re(t, a) && r(a);
  }, t.addEventListener(pe[e], s, !1)) : t.addEventListener(e, r, !1) : t.attachEvent("on" + e, s), t[$] = t[$] || {}, t[$][o] = s;
}
function ve(t, e, i, n, o) {
  ...
  if (!s)
    return this;
  !c.touchNative && c.pointer && e.indexOf("touch") === 0 ? $n(t, e, s) : c.touch && e === "dblclick" ? ro(t, s) : "removeEventListener" in t ? t.removeEventListener(pe[e] || e, s, !1) : t.detachEvent("on" + e, s), t[$][o] = null;
}
function ct(t) {
  return t.stopPropagation ? t.stopPropagation() : t.originalEvent ? t.originalEvent._stopped = !0 : t.cancelBubble = !0, this;
}
function Ne(t) {
  return ge(t, "wheel", ct), this;
}
function Rt(t) {
...
function Ri(t, e) {
  ...
  var i = Be(e), n = i.boundingClientRect;
  return new p(
...
var lo = {
  ...
  run: function(t, e, i, n) {
    this.stop(), this._el = t, this._inProgress = !0, this._duration = i || 0.25, this._easeOutPower = 1 / Math.max(n || 0.5, 0.2), this._startPos = mt(t), this._offset = e.subtract(this._startPos), this._startTime = +new Date(), this.fire("start"), this._animate();
  },
  stop: function() {
  ...
  flyTo: function(t, e, i) {
    ...
    function d(E) {
      var Ht = E ? -1 : 1, yn = E ? h : a, xn = h * h - a * a + Ht * f * f * u * u, wn = 2 * yn * f * u, ue = xn / wn, Ye = Math.sqrt(ue * ue + 1) - ue, Pn = Ye < 1e-9 ? -18 : Math.log(Ye);
      return Pn;
    }
    function R(E) {
    ...
    var U = d(0);
    function bt(E) {
      return a * (N(U) / N(U + l * E));
    }
    function mn(E) {
      return a * (N(U) * V(U + l * E) - R(U)) / f;
    }
    function pn(E) {
      return 1 - Math.pow(1 - E, 1.5);
    }
    var gn = Date.now(), Ve = (d(1) - U) / l, vn = i.duration ? 1e3 * i.duration : 1e3 * Ve * 0.8;
    function Ke() {
      var E = (Date.now() - gn) / vn, Ht = pn(E) * Ve;
      E <= 1 ? (this._flyToFrame = F(Ke, this), this._move(
        this.unproject(n.add(o.subtract(n).multiplyBy(mn(Ht) / u)), r),
        this.getScaleZoom(a / bt(Ht), r),
        { flyTo: !0 }
      )) : this._move(t, e)._moveEnd(!0);
    }
    return this._moveStart(!0, i.noMoveStart), Ke.call(this), this;
  },
  ...
  remove: function() {
    ...
    this._locationWatchId !== void 0 && this.stopLocate(), this._stop(), z(this._mapPane), this._clearControlPos && this._clearControlPos(), this._resizeRequest && (q(this._resizeRequest), this._resizeRequest = null), this._clearHandlers(), this._loaded && this.fire("unload");
    var t;
  ...
  getBoundsZoom: function(t, e, i) {
    t = I(t), i = _(i || [0, 0]);
    var n = this.getZoom() || 0, o = this.getMinZoom(), s = this.getMaxZoom(), r = t.getNorthWest(), a = t.getSouthEast(), h = this.getSize().subtract(i), u = D(this.project(a, n), this.project(r, n)).getSize(), l = c.any3d ? this.options.zoomSnap : 1, f = h.x / u.x, d = h.y / u.y, R = e ? Math.max(f, d) : Math.min(f, d);
    return n = this.getScaleZoom(R, n), l && (n = Math.round(n / (l / 100)) * (l / 100), n = e ? Math.ceil(n / l) * l : Math.floor(n / l) * l), Math.max(o, Math.min(s, n));
  },
  getSize: function() {
  ...
  _initLayout: function() {
    ...
    this._fadeAnimated = this.options.fadeAnimation && c.any3d, g(t, "leaflet-container" + (c.touch ? " leaflet-touch" : "") + (c.retina ? " leaflet-retina" : "") + (c.ielt9 ? " leaflet-oldie" : "") + (c.safari ? " leaflet-safari" : "") + (this._fadeAnimated ? " leaflet-fade-anim" : ""));
    var e = Zt(t, "position");
  ...
  _getMapPanePos: function() {
    return mt(this._mapPane) || new p(0, 0);
  },
  _moved: function() {
    var t = this._getMapPanePos();
  ...
  _createAnimProxy: function() {
    ...
    this._panes.mapPane.appendChild(t), this.on("zoomanim", function(e) {
      var i = ke, n = this._proxy.style[i];
...
var Wi = K.extend({
  ...
  initialize: function(t, e, i) {
    S(this, i), this._layerControlInputs = [], this._layers = [], this._lastZIndex = 0, this._handlingClick = !1;
    for (var n in t)
  ...
  addTo: function(t) {
    return K.prototype.addTo.call(this, t), this._expandIfNotCollapsed();
  },
  onRemove: function() {
  ...
  expand: function() {
    ...
    return t < this._section.clientHeight ? (g(this._section, "leaflet-control-layers-scrollbar"), this._section.style.height = t + "px") : k(this._section, "leaflet-control-layers-scrollbar"), this._checkDisabledLayers(), this;
  },
  collapse: function() {
  ...
  _initLayout: function() {
    ...
    i && (this._map.on("click", this.collapse, this), m(e, {
      mouseenter: function() {
        m(n, "click", B), this.expand(), setTimeout(function() {
          b(n, "click", B);
        });
      },
    ...
    o.href = "#", o.title = "Layers", o.setAttribute("role", "button"), m(o, "click", B), m(o, "focus", this.expand, this), i || this.expand(), this._baseLayersList = y("div", t + "-base", n), this._separator = y("div", t + "-separator", n), this._overlaysList = y("div", t + "-overlays", n), e.appendChild(n);
  },
  ...
  _createButton: function(t, e, i, n, o) {
    var s = y("a", i, n);
    return s.innerHTML = t, s.href = "#", s.title = e, s.setAttribute("role", "button"), s.setAttribute("aria-label", e), Rt(s), m(s, "click", pt), m(s, "click", o, this), m(s, "click", this._refocusOnMap, this), s;
  },
  _updateDisabled: function() {
    var t = this._map, e = "leaflet-disabled";
    k(this._zoomInButton, e), k(this._zoomOutButton, e), this._zoomInButton.setAttribute("aria-disabled", "false"), this._zoomOutButton.setAttribute("aria-disabled", "false"), (this._disabled || t._zoom === t.getMinZoom()) && (g(this._zoomOutButton, e), this._zoomOutButton.setAttribute("aria-disabled", "true")), (this._disabled || t._zoom === t.getMaxZoom()) && (g(this._zoomInButton, e), this._zoomInButton.setAttribute("aria-disabled", "true"));
  }
});
v.mergeOptions({
  zoomControl: !0
...
var _o = function(t) {
  ...
  return new Hi(t);
}, po = '<svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="12" height="8" viewBox="0 0 12 8" class="leaflet-attribution-flag"><path fill="#4C7BE1" d="M0 0h12v4H0z"/><path fill="#FFD500" d="M0 4h12v3H0z"/><path fill="#E0BC00" d="M0 7h12v1H0z"/></svg>', Fe = K.extend({
  options: {
  ...
  onAdd: function(t) {
    t.attributionControl = this, this._container = y("div", "leaflet-control-attribution"), Rt(this._container);
...
var vo = { Events: H }, ni = c.touch ? "touchstart mousedown" : "mousedown", at = At.extend({
  options: {
    clickTolerance: 3
  },
  ...
  disable: function() {
    !this._enabled || (at._dragging === this && this.finishDrag(!0), b(this._dragStartTarget, ni, this._onDown, this), this._enabled = !1, this._moved = !1);
  },
  _onDown: function(t) {
    if (!!this._enabled && (this._moved = !1, !Ee(this._element, "leaflet-zoom-anim"))) {
      if (t.touches && t.touches.length !== 1) {
        at._dragging === this && this.finishDrag();
        return;
      }
      if (!(at._dragging || t.shiftKey || t.which !== 1 && t.button !== 1 && !t.touches) && (at._dragging = this, this._preventOutline && Ae(this._element), Oe(), Ot(), !this._moving)) {
        this.fire("down");
        var e = t.touches ? t.touches[0] : t, i = Bi(this._element);
        this._startPoint = new p(e.clientX, e.clientY), this._startPos = mt(this._element), this._parentScale = Be(i);
  ...
  _onMove: function(t) {
    if (!!this._enabled) {
      ...
      !i.x && !i.y || Math.abs(i.x) + Math.abs(i.y) < this.options.clickTolerance || (i.x /= this._parentScale.x, i.y /= this._parentScale.y, B(t), this._moved || (this.fire("dragstart"), this._moved = !0, g(document.body, "leaflet-dragging"), this._lastTarget = t.target || t.srcElement, window.SVGElementInstance && this._lastTarget instanceof window.SVGElementInstance && (this._lastTarget = this._lastTarget.correspondingUseElement), g(this._lastTarget, "leaflet-drag-target")), this._newPos = this._startPos.add(i), this._moving = !0, this._lastEvent = t, this._updatePosition());
    }
  },
  ...
  finishDrag: function(t) {
    k(document.body, "leaflet-dragging"), this._lastTarget && (k(this._lastTarget, "leaflet-drag-target"), this._lastTarget = null), b(document, "mousemove touchmove", this._onMove, this), b(document, "mouseup touchend touchcancel", this._onUp, this), Ie(), It(), this._moved && this._moving && this.fire("dragend", {
      noInertia: t,
      distance: this._newPos.distanceTo(this._startPos)
    }), this._moving = !1, at._dragging = !1;
  }
});
function Ui(t, e) {
  if (!e || !t.length)
...
function ye(t, e, i, n, o) {
  ...
  s > i && (e[r] = 1, ye(t, e, i, n, r), ye(t, e, i, r, o));
}
function wo(t, e) {
...
function qi(t, e, i, n, o) {
  var s = n ? oi : ft(t, i), r = ft(e, i), a, h, u;
  for (oi = r; ; ) {
    if (!(s | r))
      return [t, e];
    if (s & r)
      return !1;
    a = s || r, h = Xt(t, e, a, i, o), u = ft(h, i), a === s ? (t = h, s = u) : (e = h, r = u);
  }
}
...
function Ki(t, e, i) {
  ...
  for (a = 0; a < 4; a++) {
    for (f = o[a], n = [], s = 0, l = t.length, r = l - 1; s < l; r = s++)
      h = t[s], u = t[r], h._code & f ? u._code & f || (d = Xt(u, h, f, e, i), d._code = ft(d, e), n.push(d)) : (u._code & f && (d = Xt(u, h, f, e, i), d._code = ft(d, e), n.push(d)), n.push(h));
    t = n;
  }
  return t;
}
...
var Ct = xt.extend({
  ...
  _getIconUrl: function(t) {
    return typeof Ct.imagePath != "string" && (Ct.imagePath = this._detectIconPath()), (this.options.imagePath || Ct.imagePath) + xt.prototype._getIconUrl.call(this, t);
  },
  ...
  addHooks: function() {
    ...
    this._draggable || (this._draggable = new at(t, t, !0)), this._draggable.on({
  ...
  _adjustPan: function(t) {
    var e = this._marker, i = e._map, n = this._marker.options.autoPanSpeed, o = this._marker.options.autoPanPadding, s = mt(e._icon), r = i.getPixelBounds(), a = i.getPixelOrigin(), h = D(
    ...
    if (!h.contains(s)) {
      ...
      i.panBy(u, { animate: !1 }), this._draggable._newPos._add(u), this._draggable._startPos._add(u), O(e._icon, this._draggable._newPos), this._onDrag(t), this._panRequest = F(this._adjustPan.bind(this, t));
    }
  },
  ...
  _onPreDrag: function(t) {
    this._marker.options.autoPan && (q(this._panRequest), this._panRequest = F(this._adjustPan.bind(this, t)));
  },
  _onDrag: function(t) {
  ...
  _removeIcon: function() {
    this.options.riseOnHover && this.off({
      mouseover: this._bringToFront,
      mouseout: this._resetZIndex
    }), this.options.autoPanOnFocus && b(this._icon, "focus", this._panOnFocus, this), z(this._icon), this.removeInteractiveTarget(this._icon), this._icon = null;
  },
  ...
  _initInteraction: function() {
    if (!!this.options.interactive && (g(this._icon, "leaflet-interactive"), this.addInteractiveTarget(this._icon), si)) {
...
var ut = X.extend({
  ...
  initialize: function(t, e) {
    S(this, e), this._latlng = T(t), this._radius = this.options.radius;
  },
  setLatLng: function(t) {
    var e = this._latlng;
  ...
  setStyle: function(t) {
    ...
    return ut.prototype.setStyle.call(this, t), this.setRadius(e), this;
  },
  _project: function() {
...
var He = ne.extend({
  initialize: function(t, e, i) {
    if (typeof e == "number" && (e = w({}, i, { radius: e })), S(this, e), this._latlng = T(t), isNaN(this.options.radius))
  ...
  setStyle: ut.prototype.setStyle,
  _project: function() {
    var t = this._latlng.lng, e = this._latlng.lat, i = this._map, n = i.options.crs;
    if (n.distance === ht.distance) {
      var o = Math.PI / 180, s = this._mRadius / ht.R / o, r = i.project([e + s, t]), a = i.project([e - s, t]), h = r.add(a).divideBy(2), u = i.unproject(h).lat, l = Math.acos((Math.cos(s * o) - Math.sin(e * o) * Math.sin(u * o)) / (Math.cos(e * o) * Math.cos(u * o))) / o;
...
var wt = nt.extend({
  ...
  _setLatLngs: function(t) {
    nt.prototype._setLatLngs.call(this, t), j(this._latlngs) && (this._latlngs = [this._latlngs]);
  },
  _defaultShape: function() {
...
function Jt(t, e) {
  var i = t.type === "Feature" ? t.geometry : t, n = i ? i.coordinates : null, o = [], s = e && e.pointToLayer, r = e && e.coordsToLatLng || Ue, a, h, u, l;
  if (!n && !i)
    return null;
  switch (i.type) {
    case "Point":
      return a = r(n), ri(s, t, a, e);
    case "MultiPoint":
      for (u = 0, l = n.length; u < l; u++)
        a = r(n[u]), o.push(ri(s, t, a, e));
      return new dt(o);
    case "LineString":
    case "MultiLineString":
      return h = $t(n, i.type === "LineString" ? 0 : 1, r), new nt(h, e);
    case "Polygon":
    case "MultiPolygon":
      return h = $t(n, i.type === "Polygon" ? 1 : 2, r), new wt(h, e);
...
function $t(t, e, i) {
  for (var n = [], o = 0, s = t.length, r; o < s; o++)
    r = e ? $t(t[o], e - 1, i) : (i || Ue)(t[o]), n.push(r);
  return n;
}
function Ge(t, e) {
  return t = T(t), t.alt !== void 0 ? [J(t.lng, e), J(t.lat, e), J(t.alt, e)] : [J(t.lng, e), J(t.lat, e)];
}
function oe(t, e, i, n) {
  for (var o = [], s = 0, r = t.length; s < r; s++)
    o.push(e ? oe(t[s], j(t[s]) ? 0 : e - 1, i, n) : Ge(t[s], n));
...
nt.include({
  toGeoJSON: function(t) {
    var e = !j(this._latlngs), i = oe(this._latlngs, e ? 1 : 0, !1, t);
    return Pt(this, {
...
wt.include({
  toGeoJSON: function(t) {
    var e = !j(this._latlngs), i = e && !j(this._latlngs[0]), n = oe(this._latlngs, i ? 2 : e ? 1 : 0, !0, t);
...
var Bo = Ji, re = X.extend({
  ...
  _initImage: function() {
    ...
    if (g(e, "leaflet-image-layer"), this._zoomAnimated && g(e, "leaflet-zoom-animated"), this.options.className && g(e, this.options.className), e.onselectstart = Z, e.onmousemove = Z, e.onload = M(this.fire, this, "load"), e.onerror = M(this._overlayOnError, this, "error"), (this.options.crossOrigin || this.options.crossOrigin === "") && (e.crossOrigin = this.options.crossOrigin === !0 ? "" : this.options.crossOrigin), this.options.zIndex && this._updateZIndex(), t) {
      this._url = e.src;
      return;
    }
  ...
  _initImage: function() {
    ...
    if (g(e, "leaflet-image-layer"), this._zoomAnimated && g(e, "leaflet-zoom-animated"), this.options.className && g(e, this.options.className), e.onselectstart = Z, e.onmousemove = Z, e.onloadeddata = M(this.fire, this, "load"), t) {
...
var Qi = re.extend({
  _initImage: function() {
    ...
    g(t, "leaflet-image-layer"), this._zoomAnimated && g(t, "leaflet-zoom-animated"), this.options.className && g(t, this.options.className), t.onselectstart = Z, t.onmousemove = Z;
  }
});
function Do(t, e, i) {
  return new Qi(t, e, i);
...
var Q = X.extend({
  ...
  initialize: function(t, e) {
    t && (t instanceof L.LatLng || Y(t)) ? (this._latlng = T(t), S(this, e)) : (S(this, t), this._source = e), this.options.content && (this._content = this.options.content);
  },
  openOn: function(t) {
  ...
  onAdd: function(t) {
    this._zoomAnimated = t._zoomAnimated, this._container || this._initLayout(), t._fadeAnimated && G(this._container, 0), clearTimeout(this._removeTimeout), this.getPane().appendChild(this._container), this.update(), t._fadeAnimated && G(this._container, 1), this.bringToFront(), this.options.interactive && (g(this._container, "leaflet-interactive"), this.addInteractiveTarget(this._container));
  },
  onRemove: function(t) {
    t._fadeAnimated ? (G(this._container, 0), this._removeTimeout = setTimeout(M(z, void 0, this._container), 200)) : z(this._container), this.options.interactive && (k(this._container, "leaflet-interactive"), this.removeInteractiveTarget(this._container));
  },
  getLatLng: function() {
    return this._latlng;
  },
...
var ae = Q.extend({
  ...
  onAdd: function(t) {
    Q.prototype.onAdd.call(this, t), t.fire("popupopen", { popup: this }), this._source && (this._source.fire("popupopen", { popup: this }, !0), this._source instanceof ut || this._source.on("preclick", ct));
  },
  onRemove: function(t) {
    Q.prototype.onRemove.call(this, t), t.fire("popupclose", { popup: this }), this._source && (this._source.fire("popupclose", { popup: this }, !0), this._source instanceof ut || this._source.off("preclick", ct));
  },
  getEvents: function() {
  ...
  _initLayout: function() {
    ...
    if (this._contentNode = y("div", t + "-content", i), Rt(e), Ne(this._contentNode), m(e, "contextmenu", ct), this._tipContainer = y("div", t + "-tip-container", e), this._tip = y("div", t + "-tip", this._tipContainer), this.options.closeButton) {
  ...
  _updateLayout: function() {
    ...
    o && n > o ? (e.height = o + "px", g(t, s)) : k(t, s), this._containerWidth = this._container.offsetWidth;
  },
  _animateZoom: function(t) {
...
X.include({
  ...
  _openPopup: function(t) {
    if (!(!this._popup || !this._map)) {
      ...
      if (this._popup._source === e && !(e instanceof ut)) {
...
var he = Q.extend({
  ...
  _setPosition: function(t) {
    ...
    a === "top" ? (e = h / 2, i = u) : a === "bottom" ? (e = h / 2, i = 0) : a === "center" ? (e = h / 2, i = u / 2) : a === "right" ? (e = 0, i = u / 2) : a === "left" ? (e = h, i = u / 2) : r.x < s.x ? (a = "right", e = 0, i = u / 2) : (a = "left", e = h + (l.x + f.x) * 2, i = u / 2), t = t.subtract(_(e, i, !0)).add(l).add(f), k(o, "leaflet-tooltip-right"), k(o, "leaflet-tooltip-left"), k(o, "leaflet-tooltip-top"), k(o, "leaflet-tooltip-bottom"), g(o, "leaflet-tooltip-" + a), O(o, t);
  },
  _updatePosition: function() {
...
var kt = X.extend({
  ...
  bringToFront: function() {
    return this._map && (Lt(this._container), this._setAutoZIndex(Math.max)), this;
  },
  bringToBack: function() {
  ...
  getEvents: function() {
    ...
    return this.options.updateWhenIdle || (this._onMove || (this._onMove = ci(this._onMoveEnd, this.options.updateInterval, this)), t.move = this._onMove), this._zoomAnimated && (t.zoomanim = this._animateZoom), t;
  },
  createTile: function() {
  ...
  _updateOpacity: function() {
    if (!!this._map && !c.ielt9) {
      ...
      i && !this._noPrune && this._pruneTiles(), e && (q(this._fadeFrame), this._fadeFrame = F(this._updateOpacity, this));
    }
  },
  _onOpaqueTile: Z,
        ...
        for (var f = o.min.y; f <= o.max.y; f++)
          for (var d = o.min.x; d <= o.max.x; d++) {
            ...
            if (R.z = this._tileZoom, !!this._isValidTile(R)) {
              var N = this._tiles[this._tileCoordsToKey(R)];
              N ? N.current = !0 : r.push(R);
            }
          }
        if (r.sort(function(U, bt) {
          return U.distanceTo(s) - bt.distanceTo(s);
        }), r.length !== 0) {
  ...
  _initTile: function(t) {
    ...
    t.style.width = e.x + "px", t.style.height = e.y + "px", t.onselectstart = Z, t.onmousemove = Z, c.ielt9 && this.options.opacity < 1 && G(t, this.options.opacity);
  },
  _addTile: function(t, e) {
    var i = this._getTilePos(t), n = this._tileCoordsToKey(t), o = this.createTile(this._wrapCoords(t), M(this._tileReady, this, t));
    this._initTile(o), this.createTile.length < 2 && F(M(this._tileReady, this, t, null, o)), O(o, i), this._tiles[n] = {
      el: o,
      coords: t,
      current: !0
  ...
  _tileReady: function(t, e, i) {
    ...
    i = this._tiles[n], i && (i.loaded = +new Date(), this._map._fadeAnimated ? (G(i.el, 0), q(this._fadeFrame), this._fadeFrame = F(this._updateOpacity, this)) : (i.active = !0, this._pruneTiles()), e || (g(i.el, "leaflet-tile-loaded"), this.fire("tileload", {
      tile: i.el,
      coords: t
    })), this._noTilesToLoad() && (this._loading = !1, this.fire("load"), c.ielt9 || !this._map._fadeAnimated ? F(this._pruneTiles, this) : setTimeout(M(this._pruneTiles, this), 250)));
  },
...
var vt = kt.extend({
  ...
  getTileUrl: function(t) {
    ...
    return di(this._url, w(e, this.options));
  },
...
var nn = vt.extend({
  ...
  getTileUrl: function(t) {
    var e = this._tileCoordsToNwSe(t), i = this._crs, n = D(i.project(e[0]), i.project(e[1])), o = n.min, s = n.max, r = (this._wmsVersion >= 1.3 && this._crs === Xi ? [o.y, o.x, s.y, s.x] : [o.x, o.y, s.x, s.y]).join(","), a = vt.prototype.getTileUrl.call(this, t);
    return a + fi(this.wmsParams, a, this.options.uppercase) + (this.options.uppercase ? "&BBOX=" : "&bbox=") + r;
  },
...
var it = X.extend({
  ...
  _updateTransform: function(t, e) {
    ...
    c.any3d ? _t(this._container, s, i) : O(this._container, s);
  },
  _reset: function() {
  ...
  _destroyContainer: function() {
    q(this._redrawRequest), delete this._ctx, z(this._container), b(this._container), delete this._container;
  },
  _updatePaths: function() {
  ...
  _handleMouseHover: function(t, e) {
    if (!this._mouseHoverThrottled) {
      ...
      n !== this._hoveredLayer && (this._handleMouseOut(t), n && (g(this._container, "leaflet-interactive"), this._fireEvent([n], t, "mouseover"), this._hoveredLayer = n)), this._fireEvent(this._hoveredLayer ? [this._hoveredLayer] : !1, t), this._mouseHoverThrottled = !0, setTimeout(M(function() {
...
var St = function() {
  ...
  _initPath: function(t) {
    var e = t._container = St("shape");
    g(e, "leaflet-vml-shape " + (this.options.className || "")), e.coordsize = "1 1", t._path = St("path"), e.appendChild(t._path), this._updateStyle(t), this._layers[x(t)] = t;
  },
  _addPath: function(t) {
    var e = t._container;
  ...
  _removePath: function(t) {
    var e = t._container;
    z(e), t.removeInteractiveTarget(e), delete this._layers[x(t)];
  },
  _updateStyle: function(t) {
    var e = t._stroke, i = t._fill, n = t.options, o = t._container;
    o.stroked = !!n.stroke, o.filled = !!n.fill, n.stroke ? (e || (e = t._stroke = St("stroke")), o.appendChild(e), e.weight = n.weight + "px", e.color = n.color, e.opacity = n.opacity, n.dashArray ? e.dashStyle = Y(n.dashArray) ? n.dashArray.join(" ") : n.dashArray.replace(/( *, *)/g, " ") : e.dashStyle = "", e.endcap = n.lineCap.replace("butt", "flat"), e.joinstyle = n.lineJoin) : e && (o.removeChild(e), t._stroke = null), n.fill ? (i || (i = t._fill = St("fill")), o.appendChild(i), i.color = n.fillColor || n.color, i.opacity = n.fillOpacity) : i && (o.removeChild(i), t._fill = null);
  },
  _updateCircle: function(t) {
...
}, jt = c.vml ? St : pi, Wt = it.extend({
  _initContainer: function() {
    this._container = jt("svg"), this._container.setAttribute("pointer-events", "none"), this._rootGroup = jt("g"), this._container.appendChild(this._rootGroup);
  },
  _destroyContainer: function() {
    z(this._container), b(this._container), delete this._container, delete this._rootGroup, delete this._svgSize;
  },
  _update: function() {
    if (!(this._map._animatingZoom && this._bounds)) {
      it.prototype._update.call(this);
...
c.vml && Wt.include(qo);
function rn(t) {
  return c.svg || c.vml ? new Wt(t) : null;
}
v.include({
  ...
  _createRenderer: function(t) {
    return this.options.preferCanvas && sn(t) || rn(t);
  }
});
var an = wt.extend({
  initialize: function(t, e) {
...
Wt.create = jt;
Wt.pointsToPath = gi;
rt.geometryToLayer = Jt;
rt.coordsToLatLng = Ue;
rt.coordsToLatLngs = $t;
rt.latLngToCoords = Ge;
rt.latLngsToCoords = oe;
rt.getFeature = Pt;
rt.asFeature = se;
v.mergeOptions({
  boxZoom: !0
...
var hn = et.extend({
  ...
  _onMouseDown: function(t) {
    if (!t.shiftKey || t.which !== 1 && t.button !== 1)
      return !1;
    this._clearDeferredResetState(), this._resetState(), Ot(), Oe(), this._startPoint = this._map.mouseEventToContainerPoint(t), m(document, {
      contextmenu: pt,
  ...
  _onMouseMove: function(t) {
    this._moved || (this._moved = !0, this._box = y("div", "leaflet-zoom-box", this._container), g(this._container, "leaflet-crosshair"), this._map.fire("boxzoomstart")), this._point = this._map.mouseEventToContainerPoint(t);
  ...
  _finish: function() {
    this._moved && (z(this._box), k(this._container, "leaflet-crosshair")), It(), Ie(), b(document, {
      contextmenu: pt,
      mousemove: this._onMouseMove,
      mouseup: this._onMouseUp,
      keydown: this._onKeyDown
...
v.addInitHook("addHandler", "boxZoom", hn);
v.mergeOptions({
  doubleClickZoom: !0
});
var un = et.extend({
...
v.addInitHook("addHandler", "doubleClickZoom", un);
v.mergeOptions({
  dragging: !0,
  inertia: !0,
...
var ln = et.extend({
  addHooks: function() {
    if (!this._draggable) {
      var t = this._map;
      this._draggable = new at(t._mapPane, t._container), this._draggable.on({
        dragstart: this._onDragStart,
        drag: this._onDrag,
        dragend: this._onDragEnd
  ...
  _onDragEnd: function(t) {
    ...
    if (e.fire("dragend", t), n)
      ...
      !d.x && !d.y ? e.fire("moveend") : (d = e._limitOffset(d, e.options.maxBounds), F(function() {
        e.panBy(d, {
          duration: f,
          easeLinearity: r,
          noMoveStart: !0,
...
v.addInitHook("addHandler", "dragging", ln);
v.mergeOptions({
  keyboard: !0,
  keyboardPanDelta: 80
});
...
v.addInitHook("addHandler", "keyboard", cn);
v.mergeOptions({
  scrollWheelZoom: !0,
...
var fn = et.extend({
  ...
  _onWheelScroll: function(t) {
    ...
    clearTimeout(this._timer), this._timer = setTimeout(M(this._performZoom, this), n), pt(t);
  },
...
v.addInitHook("addHandler", "scrollWheelZoom", fn);
var Vo = 600;
v.mergeOptions({
  ...
  _onDown: function(t) {
    if (clearTimeout(this._holdTimeout), t.touches.length === 1) {
      ...
      this._startPos = this._newPos = new p(e.clientX, e.clientY), this._holdTimeout = setTimeout(M(function() {
        this._cancel(), this._isTapValid() && (m(document, "touchend", B), m(document, "touchend touchcancel", this._cancelClickPrevent), this._simulateEvent("contextmenu", e));
      }, this), Vo), m(document, "touchend touchcancel contextmenu", this._cancel, this), m(document, "touchmove", this._onMove, this);
    }
  },
...
v.addInitHook("addHandler", "tapHold", dn);
v.mergeOptions({
  touchZoom: c.touch,
...
var _n = et.extend({
  ...
  _onTouchMove: function(t) {
    if (!(!t.touches || t.touches.length !== 2 || !this._zooming)) {
      ...
      this._animRequest = F(r, this, !0), B(t);
    }
  },
...
v.addInitHook("addHandler", "touchZoom", _n);
v.BoxZoom = hn;
v.DoubleClickZoom = un;
v.Drag = ln;
v.Keyboard = cn;
v.ScrollWheelZoom = fn;
v.TapHold = dn;
v.TouchZoom = _n;
var Ko = {
  __proto__: null,
  ...
  Map: v,
  map: co
}, A = w(Ko, { noConflict: Xo }), je = Jo(), Yo = je.L;
je.L = A;
function Xo() {
  return je.L = Yo, A;
}
...
A.TileLayer.BetterWMS = A.TileLayer.WMS.extend({
  onAdd: function(t) {
    A.TileLayer.WMS.prototype.onAdd.call(this, t), t.on("click", this.getFeatureInfo, this);
  },
  onRemove: function(t) {
    A.TileLayer.WMS.prototype.onRemove.call(this, t), t.off("click", this.getFeatureInfo, this);
  },
  getFeatureInfo: function(t) {
    const e = this.getFeatureInfoUrl(t.latlng), i = A.Util.bind(this.showGetFeatureInfo, this);
  ...
  getFeatureInfoUrl: function(t) {
    ...
    return n[n.version === "1.3.0" ? "i" : "x"] = e.x, n[n.version === "1.3.0" ? "j" : "y"] = e.y, console.log(A.Util.getParamString(n, this._url, !0)), this._url + A.Util.getParamString(n, this._url, !0);
  },
  showGetFeatureInfo: function(t, e, i) {
    ...
    A.popup({ maxWidth: 800 }).setLatLng(e).setContent(i).openOn(this._map);
  }
});
A.tileLayer.betterWms = function(t, e) {
  return new A.TileLayer.BetterWMS(t, e);
};
...
async function ts(t, e) {
  return (await Promise.all(e.map((n) => Qo(t, n)))).map((n, o) => ({ bounds: n, layers: `${t}:${e[o]}` }));
}
const es = /* @__PURE__ */ Ln({
  ...
  setup(t, { emit: e }) {
    const i = Tn();
    return bn(() => {
      const n = A.map(i.value, {
        center: [34.15754, 117.20851],
        zoom: 15,
        zoomControl: !1
      });
      A.tileLayer.chinaProvider("TianDiTu.Normal.Map", {
        key: "f2ae54b1dcb16d4a9f478401edf0054e",
        maxZoom: 18,
        minZoom: 5
      }).addTo(n), A.tileLayer.chinaProvider("TianDiTu.Normal.Annotion", {
        key: "f2ae54b1dcb16d4a9f478401edf0054e",
        maxZoom: 18,
        minZoom: 5
      }).addTo(n);
      ...
      ts(o, s).then((l) => {
        ...
        const f = n.latLngToContainerPoint(l.latlng), d = n.getSize(), R = u.map((N) => {
          const V = N._url, U = {
            request: "GetFeatureInfo",
            service: "WMS",
            srs: "EPSG:4326",
            styles: N.wmsParams.styles,
            transparent: a,
            version: N.wmsParams.version,
            format: h,
            bbox: n.getBounds().toBBoxString(),
            height: d.y,
            width: d.x,
            layers: N.wmsParams.layers,
            query_layers: N.wmsParams.layers,
            info_format: "application/json",
            x: f.x,
            y: f.y
          };
          return fetch(V + A.Util.getParamString(U, V, !0)).then((bt) => bt.json());
        });
...
}), os = /* @__PURE__ */ ui(es, [["__file", "C:/Users/chen-pc/WebstormProjects/njhh-ui/lib/njhh-wms-map.vue"]]);
export {
  ns as DemoUi,
  os as NjhhWmsMap
};
